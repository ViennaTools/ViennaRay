...
template <typename NumericType> class rtTracingData {
private:
...
public:
  ...
  rtTracingData(const rtTracingData &otherData)
  ...
  void
  setVectorMergeType(const std::vector<rtTracingDataMergeEnum> &mergeType) {
  ...
  void
  setScalarMergeType(const std::vector<rtTracingDataMergeEnum> &mergeType) {
