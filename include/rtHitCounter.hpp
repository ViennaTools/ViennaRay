...
public:
    ...
    rtHitCounter(size_t size) : mCnts(size, 0),
                                mTotalCnts(0),
                                mDiscAreas(size, 0),
                                mS1s(size, 0),
                                mS2s(size, 0)
    ...
    rtHitCounter(rtHitCounter<NumericType> const &pA) : mCnts(pA.mCnts),
                                                        mTotalCnts(pA.mTotalCnts),
                                                        mDiscAreas(pA.mDiscAreas),
                                                        mS1s(pA.mS1s),
                                                        mS2s(pA.mS2s)
    {
    }
    ...
    rtHitCounter(rtHitCounter<NumericType> const &&pA) : mCnts(std::move(pA.mCnts)),
                                                         mTotalCnts(std::move(pA.mTotalCnts)),
                                                         mDiscAreas(std::move(pA.mDiscAreas)),
    ...
    rtHitCounter(rtHitCounter<NumericType> const &pA1,
                 rtHitCounter<NumericType> const &pA2) : rtHitCounter(pA1)
    {
        ...
        {
            mDiscAreas[idx] = pA1.mDiscAreas[idx] > pA2.mDiscAreas[idx] ? pA1.mDiscAreas[idx] : pA2.mDiscAreas[idx];
        }
    }

    rtHitCounter<NumericType> &operator=(rtHitCounter<NumericType> const &pOther)
    {
        if (this != &pOther)
        {
